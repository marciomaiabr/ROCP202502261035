...
public class Exe001 {
	...
	private void go() {
		...
		int nThreads = 3;
		ExecutorService es = Executors.newScheduledThreadPool(nThreads);
		...
		sleep(7*1000);
		System.out.println('\n'+"temos "+(Thread.currentThread().activeCount())+" Threads criadas e ativas");
		...
		sleep(9*7*1000);
		System.out.println('\n'+"temos "+(Thread.currentThread().activeCount())+" Threads criadas e nenhuma mais ativa");
		System.out.println("["+(TimeLog.printTime())+"]"+"[Thread.currentThread().activeCount()="+(Thread.currentThread().activeCount())+"]"+"[f1.isDone()="+(f1.isDone())+"]"+"[f2.isDone()="+(f2.isDone())+"]"+"[f3.isDone()="+(f3.isDone())+"]"+"[f4.isDone()="+(f4.isDone())+"]"+"[f5.isDone()="+(f5.isDone())+"]"+'\n');
